...
//-------------------------------------------------------------------------------------
std::string ClientSDKUE5::typeToType(const std::string& type)
{
	if (type == "INT8")
	{
		return "int8";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::getArrayType(DataType* pDataType, std::string& outstr)
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateTypeFileName()
{
	sourcefileName_ = "";
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateEntityModuleFileName(const std::string& moduleName)
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateServerErrorDescrsModuleFileName()
{
	sourcefileName_ = "";
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateEngineMessagesModuleFileName()
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateDefsCustomTypesModuleFileName()
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onCreateEntityDefsModuleFileName()
{
...
//-------------------------------------------------------------------------------------
void ClientSDKUE5::onEntityCallModuleFileName(const std::string& moduleName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeServerErrorDescrsModuleBegin()
{
	fileBody() = headerBody;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeServerErrorDescrsModuleErrDescr(int errorID, const std::string& errname, const std::string& errdescr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeServerErrorDescrsModuleEnd()
{
	fileBody() += "\t}\n\n";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEngineMessagesModuleBegin()
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEngineMessagesModuleMessage(Network::ExposedMessageInfo& messageInfos, COMPONENT_TYPE componentType)
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEngineMessagesModuleEnd()
{
	changeContextToSource();
	fileBody() += namespaceNameEnd;
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleBegin()
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleEnd()
{
	changeContextToSource();
	fileBody() += namespaceNameEnd;
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitScriptBegin()
{
	changeContextToSource();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitScriptEnd()
{
	changeContextToSource();
	fileBody() += "}\n\n";
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitDefTypesBegin()
{
	changeContextToSource();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitDefTypesEnd()
{
	changeContextToSource();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitDefType(const DataType* pDataType)
{
	changeContextToSource();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	fileBody() = headerBody;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	changeContextToSource();
	fileBody() += namespaceNameEnd;
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityCallMethodBegin(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription, const char* fillString1, const char* fillString2, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityCallMethodEnd(ScriptDefModule* pScriptDefModule, MethodDescription* pMethodDescription)
{
	changeContextToSource();
	fileBody() += fmt::format("}}\n\n");
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeBaseEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	changeContextToHeader();
	std::string newModuleName;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeBaseEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	changeContextToHeader();
	fileBody() += fmt::format("}};\n");
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeCellEntityCallBegin(ScriptDefModule* pScriptDefModule)
{
	changeContextToHeader();
	std::string newModuleName;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeCellEntityCallEnd(ScriptDefModule* pScriptDefModule)
{
	changeContextToHeader();
	fileBody() += fmt::format("}};\n");
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeCustomDataTypesBegin()
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeCustomDataTypesEnd()
{
	changeContextToSource();
	fileBody() += namespaceNameEnd;
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::createArrayChildClass(DataType* pRootDataType, DataType* pDataType, const std::string& className, const std::string& tabs, int numLayer)
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeCustomDataType(const DataType* pDataType)
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitScript_ScriptModule(ScriptDefModule* pScriptDefModule)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitScript_MethodDescr(ScriptDefModule* pScriptDefModule, MethodDescription* pDescr, COMPONENT_TYPE componentType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityDefsModuleInitScript_PropertyDescr(ScriptDefModule* pScriptDefModule, PropertyDescription* pDescr)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypesBegin()
{
	fileBody() = headerBody;
	strutil::kbe_replace(fileBody(), "#REPLACE#", "");
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypesEnd()
{
	fileBody() += namespaceNameEnd;
	return true;
}
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeBegin(std::string typeName, FixedDictType* pDataType)
{
	initBody_ = "";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeEnd(std::string typeName, FixedDictType* pDataType)
{
	if (initBody_.size() > 0)
	{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeBegin(std::string typeName, FixedArrayType* pDataType, const std::string& parentClass)
{
	initBody_ = "";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeEnd(std::string typeName, FixedArrayType* pDataType)
{
	if (initBody_.size() > 0)
	{
		initBody_ = std::string(":\n") + initBody_;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeBegin(std::string typeName, DataType* pDataType)
{
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeEnd(std::string typeName, DataType* pDataType)
{
	return true;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_AliasName(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_INT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_INT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_INT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_INT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_UINT8(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_UINT16(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_UINT32(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_UINT64(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_FLOAT(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_DOUBLE(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_STRING(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_UNICODE(const std::string& itemName, const std::string& childItemName)
{
	fileBody() += fmt::format("\tFString {};\n", itemName);
	initBody_ += fmt::format("\t{}({}),\n", itemName, "");
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_PYTHON(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_PY_DICT(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_PY_TUPLE(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_PY_LIST(const std::string& itemName, const std::string& childItemName)
{
	return writeTypeItemType_BLOB(itemName, childItemName);
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_BLOB(const std::string& itemName, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_ARRAY(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
	std::string typeStr;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_FIXED_DICT(const std::string& itemName, const std::string& childItemName, DataType* pDataType)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_VECTOR2(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_VECTOR3(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_VECTOR4(const std::string& itemName, const std::string& childItemName)
{
#ifdef CLIENT_NO_FLOAT
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeTypeItemType_ENTITYCALL(const std::string& itemName, const std::string& childItemName)
{
	fileBody() += fmt::format("\tTArray<uint8> {};\n", itemName);
	initBody_ += fmt::format("\t{}({}),\n", itemName, "");
	return true;
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityModuleBegin(ScriptDefModule* pEntityScriptDefModule)
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityModuleEnd(ScriptDefModule* pEntityScriptDefModule)
{
	changeContextToHeader();
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProcessMessagesMethod(ScriptDefModule* pEntityScriptDefModule)
{
	std::string ownstr = "";
	if (pEntityScriptDefModule->isComponentModule())
		ownstr = "pOwner->";
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityPropertyComponent(ScriptDefModule* pEntityScriptDefModule,
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_INT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tint8 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_INT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tint16 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_INT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tint32 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_INT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tint64 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_UINT8(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tuint8 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_UINT16(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tuint16 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_UINT32(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tuint32 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_UINT64(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tuint64 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_FLOAT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tfloat {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_DOUBLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tdouble {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_STRING(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tFString {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_UNICODE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tFString {};\n", pPropertyDescription->getName());
	initBody_ += fmt::format("\t{}(TEXT(\"{}\")),\n", pPropertyDescription->getName(), (strlen(pPropertyDescription->getDefaultValStr()) > 0 ? pPropertyDescription->getDefaultValStr() : ""));
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_PYTHON(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUE5::writeEntityProperty_PYTHON(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_PY_DICT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUE5::writeEntityProperty_PY_DICT(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_PY_TUPLE(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUE5::writeEntityProperty_PY_TUPLE(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_PY_LIST(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	ERROR_MSG("ClientSDKUE5::writeEntityProperty_PY_LIST(): nonsupport!\n");
	return false;
}

//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_BLOB(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tTArray<uint8> {};\n", pPropertyDescription->getName());
	initBody_ += fmt::format("\t{}(),\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_ARRAY(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_FIXED_DICT(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\t{} {};\n", pPropertyDescription->getDataTypeName(), pPropertyDescription->getName());
	initBody_ += fmt::format("\t{}(),\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_VECTOR2(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	fileBody() += fmt::format("\tFVector2D {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_VECTOR3(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	fileBody() += fmt::format("\tFVector3f {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_VECTOR4(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
#ifdef CLIENT_NO_FLOAT
	fileBody() += fmt::format("\tFVector4 {};\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityProperty_ENTITYCALL(ScriptDefModule* pEntityScriptDefModule,
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	fileBody() += fmt::format("\tTArray<uint8> {};\n", pPropertyDescription->getName());
	initBody_ += fmt::format("\t{}(),\n", pPropertyDescription->getName());
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityMethod(ScriptDefModule* pEntityScriptDefModule,
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityMethodArgs_ARRAY(FixedArrayType* pFixedArrayType, std::string& stackArgsTypeBody, const std::string& childItemName)
{
...
//-------------------------------------------------------------------------------------
bool ClientSDKUE5::writeEntityMethodArgs_Const_Ref(DataType* pDataType, std::string& stackArgsTypeBody)
{
