...
{
	// C++ SDK 使用 uint16 作为错误表键，生成前拒绝无法由协议表示的错误码。
	// The C++ SDK uses uint16 error-table keys, so reject IDs the protocol cannot represent before generation.
	if (errorID < 0 || errorID > std::numeric_limits<uint16>::max())
	{
		ERROR_MSG(fmt::format("ClientSDKCXX::writeServerErrorDescrsModuleErrDescr: errorID({}) is outside uint16 range!\n", errorID));
		return false;
	}

	fileBody() += fmt::format("\t\t{{\n\t\t\tFKServerErr e;\n\t\t\te.id = {};\n\t\t\te.name = KBTEXT(\"{}\");\n\t\t\te.descr = KBTEXT(\"{}\");\n\n\t\t\tserverErrs_.Add(static_cast<uint16>(e.id), e);\n", errorID, errname, errdescr);
	fileBody() += "\t\t}\n\n";
	return true;
}
...
bool ClientSDKCXX::writeEngineMessagesModuleBegin()
{
	...
	fileBody() += "\tvirtual void handleMessage(MemoryStream&)\n";
	fileBody() += "\t{\n";
	fileBody() += "\t}\n\n";
...
{
	const bool usesMessageStream = componentType == CLIENT_TYPE &&
		(messageInfos.argsTypes.size() > 0 || messageInfos.argsType < 0);
	...
	fileBody() += fmt::format("void Message_{}::handleMessage(MemoryStream&{})\n", messageInfos.name,
		usesMessageStream ? " msgstream" : "");
	fileBody() += "{\n";
	fileBody() += "\ttry\n\t{\n";
...
bool ClientSDKCXX::writeEntityProcessMessagesMethod(ScriptDefModule* pEntityScriptDefModule)
{
	...
	else if (pEntityScriptDefModule->isComponentModule())
	{
		fileBody() += "\t(void)methodUtype;\n";
		fileBody() += "\t(void)stream;\n";
	}
	else
	{
		fileBody() += "\t(void)stream;\n";
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(int8) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(int16) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(int32) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(int64) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(uint8) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(uint16) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(uint32) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(uint64) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(float) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(double) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(const KBString&) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(const KBVector2f&) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(const KBVector3f&) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(const KBVector4f&) {{}}\n", name);
	return true;
}
	...
	ScriptDefModule* pCurrScriptDefModule, PropertyDescription* pPropertyDescription)
{
	...
	std::string name = pPropertyDescription->getName();
	name[0] = std::toupper(name[0]);
	fileBody() += fmt::format("\tvirtual void on{}Changed(const KBArray<uint8>&) {{}}\n", name);
	return true;
}
