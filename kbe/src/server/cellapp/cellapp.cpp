...
bool Cellapp::initializeWatcher()
{
	...
	WATCH_OBJECT("witness/scheduler/pendingSnapshot", &Witness::globalPendingSnapshot);
	...
	WATCH_OBJECT("witness/scheduler/pendingArrivals", &Witness::globalPendingArrivalCount);
