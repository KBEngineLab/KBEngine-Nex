...
set(_kbe_sensitive_sources
	...
	"server/dbmgr/account_request_guard.cpp"
	"server/dbmgr/account_request_guard.h"
...
foreach(_kbe_required IN ITEMS
	...
	"Cellappmgr::forwardMessage: rejected incomplete header"
	"Cellappmgr::reqCreateCellEntityInNewSpace: rejected malformed or oversized payload"
	"Cellappmgr::reqRestoreSpaceInCell: rejected malformed or oversized payload"
	"Cellapp::onCreateCellEntityInNewSpaceFromBaseapp: rejected malformed or oversized payload"
	"Cellapp::onRestoreSpaceInCellFromBaseapp: rejected malformed or oversized payload"
	...
	"Dbmgr::writeEntity: rejected shouldAutoLoad="
	"resolveDbInterfaceName(\"Dbmgr::writeEntity\""
	"validateCreateAccountStream"
	"validateLoginStream"
	"validateInterfacesCallbackStream"
	"Dbmgr::reqCreateAccount: rejected malformed or oversized payload"
	"Dbmgr::onAccountLogin: rejected malformed or oversized payload"
