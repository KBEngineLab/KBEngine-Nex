...
PROBES = (
    ...
    (
        ...
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::onUpdateGhostPropertys",
        r"Cellapp::onUpdateGhostPropertys: rejected incomplete fixed header",
    ),
    (
        "cellapp-truncated-real-method",
        "cellapp",
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::onRemoteRealMethodCall",
        r"Cellapp::onRemoteRealMethodCall: rejected incomplete fixed header",
    ),
    (
        "cellapp-truncated-ghost-volatile",
        "cellapp",
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::onUpdateGhostVolatileData",
        r"Cellapp::onUpdateGhostVolatileData: rejected incomplete fixed header",
    ),
    (
        "cellapp-truncated-teleport-request",
        "cellapp",
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::reqTeleportToCellApp",
        r"Cellapp::reqTeleportToCellApp: rejected incomplete fixed header",
    ),
    (
        "cellapp-truncated-teleport-callback",
        "cellapp",
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::reqTeleportToCellAppCB",
        r"Cellapp::reqTeleportToCellAppCB: rejected incomplete fixed header",
    ),
    (
        ...
        "internal",
        "CELLAPP_TYPE",
        "Cellapp::reqTeleportToCellAppOver",
        r"Cellapp::reqTeleportToCellAppOver: rejected incomplete fixed header",
    ),
    (
