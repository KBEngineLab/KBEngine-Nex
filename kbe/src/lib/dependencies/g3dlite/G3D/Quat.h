...
public:
   ...
   */
	...
	*/
	...
	/*
	* ŷ����ת������Ԫ�����˹�ʽ���붨����ת˳����ת˳����Z��X��Y
	* ��ͬ����ת˳����ͨ��q=qy*qx*qz���Ϳ������ݳ�����Ĺ�ʽ(w,x,y,z)����Ȼ
	* qx = ['cos(X/2)','sin(X/2)','0','0']      ������(1,0,0)˳ʱ��X��
	* qz = ['cos(Z/2)','0','0','sin(Z/2)']	  ������(0,0,1)˳ʱ��Z��
	* qy = ['cos(Y/2)', '0','sin(Y/2)', '0']	  ������(0,1,0)˳ʱ��Y��
	*/
